 ...
 @section('content')
 @push('seo-meta')
 <meta name="description" content="{{ $category_name->meta_desc }}">
 <meta name="title" content="{{ $category_name->meta_title }}"/>
 <meta name="keywords" content="{{ $category_name->meta_keywords }}">
 ...
 <div class="features_items"><!--features_items-->
    <h2 class="title text-center">Danh mục {{$category_name->name}}</h2>
